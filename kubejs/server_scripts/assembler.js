ServerEvents.recipes(event => {
	...
	event.remove({ output: 'gtceu:steel_crate' })
	event.remove({ output: 'toms_storage:ts.storage_terminal' })
	event.remove({ output: 'toms_storage:ts.crafting_terminal' })

event.recipes.gtceu.assembler('storage_terminal')
		.circuit(1)
		.itemInputs(Item.of('1x create:andesite_casing'))
		.itemInputs(Item.of('1x #forge:chests/wooden'))
		.itemInputs(Item.of('1x #gtceu:circuits/lv'))
		.itemInputs(Item.of('1x minecraft:amethyst_shard'))
		.inputFluids(Fluid.of('kubejs:glass_residue',144))
		.itemOutputs(Item.of('1x toms_storage:ts.storage_terminal'))
		.duration(200)
		.EUt(30)
event.recipes.gtceu.assembler('crafting_terminal')
		.circuit(1)
		.itemInputs(Item.of('1x toms_storage:ts.storage_terminal'))
		.itemInputs(Item.of('1x minecraft:crafting_table'))
		.itemInputs(Item.of('4x gtceu:andesite_alloy_screw'))
		.inputFluids(Fluid.of('kubejs:glass_residue',144))
		.itemOutputs(Item.of('1x toms_storage:ts.crafting_terminal'))
		.duration(200)
		.EUt(30)
event.recipes.gtceu.assembler('steel_crate')
		.circuit(1)
		.itemInputs(Item.of('4x gtceu:natures_alloy_plate'))
		.itemInputs(Item.of('4x gtceu:long_natures_alloy_rod'))
		.itemOutputs(Item.of('1x gtceu:steel_crate'))
		.duration(200)
		.EUt(16)
	...
	event.recipes.gtceu.assembler('lv_machine_casing')
		...
		.duration(50)
		.EUt(16)
		event.recipes.gtceu.assembler('lv_electric_motor')
		.itemInputs(Item.of('2x gtceu:blazing_single_cable'))
		.itemInputs(Item.of('4x gtceu:glowing_single_wire'))
		.itemInputs(Item.of('1x gtceu:magnetic_iron_rod'))
		.itemInputs(Item.of('4x gtceu:natures_alloy_rod'))
		.itemOutputs(Item.of('1x gtceu:lv_electric_motor'))
		.duration(100)
		.EUt(30)
		event.recipes.gtceu.assembler('lv_electric_piston')
		.itemInputs(Item.of('2x gtceu:blazing_single_cable'))
		.itemInputs(Item.of('3x gtceu:natures_alloy_plate'))
		.itemInputs(Item.of('1x gtceu:small_natures_alloy_gear'))
		.itemInputs(Item.of('2x gtceu:natures_alloy_rod'))
		.itemInputs(Item.of('1x gtceu:lv_electric_motor'))

		.itemOutputs(Item.of('1x gtceu:lv_electric_piston'))
		.duration(100)
		.EUt(30)
	...
	event.recipes.gtceu.assembler('mv_machine_hull')
		.itemInputs(Item.of('1x gtceu:mv_machine_casing'))
	...
	event.recipes.gtceu.assembler('frostproof_machine_casing')
		...
		event.recipes.gtceu.assembler('fleshcrete')
		.circuit(1)
		.itemInputs(Item.of('2x #forge:concrete_powders'))
		.itemInputs(Item.of('1x gtceu:sterile_bio_alloy_frame'))
		.itemInputs(Item.of('6x gtceu:weak_synthetic_plate'))
		.inputFluids(Fluid.of('kubejs:clean_growth_medium',144))
		.itemOutputs(Item.of('2x gtceu:plascrete'))
		.duration(120)
		.EUt(128)
		event.recipes.gtceu.assembler('lab_casing')
		.itemInputs(Item.of('1x botania:corporea_brick'))
		.circuit(6)
		.inputFluids(Fluid.of('kubejs:life_activated_bioplastic',216))
		.itemOutputs(Item.of('1x kubejs:clean_lab_machine_casing'))
		.duration(50)
		.EUt(16)
		event.recipes.gtceu.assembler('packager')
		.itemInputs(Item.of('4x gtceu:double_andesite_alloy_plate'))
		.itemInputs(Item.of('#gtceu:circuits/mv'))
		.itemInputs(Item.of('gtceu:lv_conveyor_module'))
		.itemInputs(Item.of('gtceu:arcane_gold_frame'))
		.itemOutputs(Item.of('1x create:packager'))
		.duration(200)
		.EUt(32)
		event.recipes.gtceu.assembler('stock_link')
		.itemInputs(Item.of('1x #forge:glass'))
		.itemInputs(Item.of('#gtceu:circuits/lv'))
		.itemInputs(Item.of('create:electron_tube'))
		.itemOutputs(Item.of('1x create:stock_link'))
		.duration(100)
		.EUt(32)
})
