ServerEvents.recipes(event => {
	...
	event.recipes.gtceu.mega_mixer('desert_essence_2')
		...
		.duration(2400)
		.EUt(480)	
		event.recipes.gtceu.mega_mixer('champions_alloy_dust')
		.itemInputs(Item.of('1x terramity:virentium_alloy_ingot'))
		.itemInputs(Item.of('1x terramity:cosmilite_ingot'))
		.itemInputs(Item.of('1x terramity:dimlite_ingot'))
		.itemInputs(Item.of('1x terramity:conductite'))
		.itemInputs(Item.of('1x terramity:void_alloy'))
		.itemInputs(Item.of('1x terramity:hellspec_alloy'))
		.itemInputs(Item.of('1x terramity:nyxium'))
		.itemInputs(Item.of('1x terramity:exodium'))
		.itemInputs(Item.of('1x terramity:reverium'))

		.itemOutputs(Item.of('1x gtceu:champions_alloy_dust'))
		.duration(1200)
		.EUt(2048)
})
