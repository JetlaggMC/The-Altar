...
event.remove({ input: 'create:andesite_alloy', type: 'minecraft:stonecutting' })
...
event.remove({ output: 'gtceu:cupronickel_dust' })
  ...
  event.recipes.create.mixing('minecraft:glowstone_dust',	['1x minecraft:glow_berries','1x gtceu:netherrack_dust'])
   ...
   event.recipes.create.mixing('1x gtceu:glass_dust',	['1x gtceu:quartz_sand_dust', '1x gtceu:tiny_flint_dust'])
	...
	event.recipes.create.mixing('1x gtceu:vacuum_tube',	['1x gtceu:glass_tube', '2x gtceu:natures_alloy_bolt', '3x gtceu:glowing_single_wire'])
 	...
 	event.recipes.create.mixing('4x kubejs:primitive_research',['1x gtceu:andesite_dust', '1x gtceu:crushed_iron_ore', Fluid.of('kubejs:molten_amethyst',100),Fluid.of('kubejs:carrot_juice',100)])
...
event.shaped('1x gtceu:glass_tube', [
  'A', 
  'B',
'B'
], {
...
event.shaped('1x gtceu:temperate_garden', [
  'ABA', 
  'CDC',
  'ABA'
], {
...
event.shaped('1x gtceu:hydroponic_garden', [
  'ABA', 
  'CDC',
  'ABA'
], {
