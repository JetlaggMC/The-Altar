ServerEvents.recipes(event => {
    ...
    event.recipes.botania.mana_infusion( "botania:mana_powder","gtceu:natures_alloy_dust", 200)
    event.recipes.botania.mana_infusion( "gtceu:phenolic_circuit_board","botania:livingwood_planks", 200)
