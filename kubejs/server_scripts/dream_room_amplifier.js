ServerEvents.recipes(event => {
	...
	event.recipes.gtceu.dream_room_amplifier('magical_meat_glob')
		...
		.itemInputs(Item.of('16x kubejs:raw_meat_glob'))
		...
		.itemInputs(Item.of('2x farmersdelight:hamburger'))
		.itemInputs(Item.of('2x farmersdelight:chicken_soup'))
	...
	event.recipes.gtceu.dream_room_amplifier('magical_plant_glob')
		...
		.itemInputs(Item.of('2x farmersdelight:fruit_salad'))
