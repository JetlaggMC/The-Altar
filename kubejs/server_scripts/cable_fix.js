ServerEvents.recipes(event => {
	...
	event.remove({ output: 'gtceu:awakened_echo_single_cable'})
	event.remove({ output: 'gtceu:awakened_echo_double_cable'})
	event.remove({ output: 'gtceu:awakened_echo_quadruple_cable'})
	event.remove({ output: 'gtceu:awakened_echo_octal_cable'})
	event.remove({ output: 'gtceu:awakened_echo_hex_cable'})
  event.recipes.create.sequenced_assembly('gtceu:red_alloy_single_cable','gtceu:red_alloy_single_wire', [
   ...
   event.recipes.create.sequenced_assembly('gtceu:blazing_single_cable','gtceu:blazing_single_wire', [
		...
		event.recipes.createPressing('gtceu:blazing_single_wire','gtceu:blazing_single_wire')
			...
			event.recipes.gtceu.assembler('blazing_single_cable')
		.itemInputs(Item.of('1x gtceu:blazing_single_wire'))
		.inputFluids(Fluid.of('kubejs:crude_insulator',36))
		.itemOutputs(Item.of('1x gtceu:blazing_single_cable'))
		.duration(100)
		.EUt(7)
			event.recipes.gtceu.assembler('blazing_double_cable')
		.itemInputs(Item.of('1x gtceu:blazing_double_wire'))
		.inputFluids(Fluid.of('kubejs:crude_insulator',36))
		.itemOutputs(Item.of('1x gtceu:blazing_double_cable'))
		.duration(100)
		.EUt(7)
			event.recipes.gtceu.assembler('blazing_quadruple_cable')
		.itemInputs(Item.of('1x gtceu:blazing_quadruple_wire'))
		.inputFluids(Fluid.of('kubejs:crude_insulator',72))
		.itemOutputs(Item.of('1x gtceu:blazing_quadruple_cable'))
		.duration(100)
		.EUt(7)
			event.recipes.gtceu.assembler('blazing_octal_cable')
		.itemInputs(Item.of('1x gtceu:blazing_octal_wire'))
		.inputFluids(Fluid.of('kubejs:crude_insulator',108))
		.itemOutputs(Item.of('1x gtceu:blazing_octal_cable'))
		.duration(100)
		.EUt(7)
			event.recipes.gtceu.assembler('blazing_hex_cable')
		.itemInputs(Item.of('1x gtceu:blazing_hex_wire'))
		.inputFluids(Fluid.of('kubejs:crude_insulator',180))
		.itemOutputs(Item.of('1x gtceu:blazing_hex_cable'))
		.duration(100)
		.EUt(7)
		...
		event.recipes.gtceu.assembler('awakened_echo_single_cable')
		.itemInputs(Item.of('1x gtceu:awakened_echo_single_wire'))
		.inputFluids(Fluid.of('kubejs:dense_insulator',36))
		.itemOutputs(Item.of('1x gtceu:awakened_echo_single_cable'))
		.duration(100)
		.EUt(7)
		event.recipes.gtceu.assembler('awakened_echo_double_cable')
		.itemInputs(Item.of('1x gtceu:awakened_echo_double_wire'))
		.inputFluids(Fluid.of('kubejs:dense_insulator',36))
		.itemOutputs(Item.of('1x gtceu:awakened_echo_double_cable'))
		.duration(100)
		.EUt(7)
		event.recipes.gtceu.assembler('awakened_echo_quadruple_cable')
		.itemInputs(Item.of('1x gtceu:awakened_echo_quadruple_wire'))
		.inputFluids(Fluid.of('kubejs:dense_insulator',72))
		.itemOutputs(Item.of('1x gtceu:awakened_echo_quadruple_cable'))
		.duration(100)
		.EUt(7)
		event.recipes.gtceu.assembler('awakened_echo_octal_cable')
		.itemInputs(Item.of('1x gtceu:awakened_echo_octal_wire'))
		.inputFluids(Fluid.of('kubejs:dense_insulator',108))
		.itemOutputs(Item.of('1x gtceu:awakened_echo_octal_cable'))
		.duration(100)
		.EUt(7)
		event.recipes.gtceu.assembler('awakened_echo_hex_cable')
		.itemInputs(Item.of('1x gtceu:awakened_echo_hex_wire'))
		.inputFluids(Fluid.of('kubejs:dense_insulator',180))
		.itemOutputs(Item.of('1x gtceu:awakened_echo_hex_cable'))
		.duration(100)
		.EUt(7)
})